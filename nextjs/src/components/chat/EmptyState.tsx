        ...
        <div className="text-center space-y-4 sm:space-y-6">
          ...
          <div className="space-y-2 sm:space-y-3">
            ...
            <p className="text-sm sm:text-base text-slate-400 px-2">
              I&apos;m here to help you save time on finding candidates, improve
              GitHub sourcing, and make smarter tech recruiting decisions.
            </p>
          </div>
        </div>
            ...
            {promptTemplates.map((template, index) => {
              ...
              return (
                <button
                  key={index}
                  onClick={() =>
                    handlePromptClick(template.query, template.mode)
                  }
                ...
                >
                  ...
                  />
                  <span
                    className={`group-hover:text-slate-100 text-xs sm:text-sm leading-relaxed ${
                      isSecondary ? "text-amber-300" : "text-slate-300"
                    }`}
                  >
                    {template.text}
                  </span>
