...
María Cruz · Posted 15 days ago
·
Kaggle Staff
[Updated with links] Welcome to the Capstone Project – Here’s How to Begin
Information for newbies
New to machine learning and data science? No question is too basic or simple. Feel free to start your own discussion thread, or use this thread to post any clarifying questions - our Kaggle community is here to help!

New to Kaggle? Check out these videos to learn more about site etiquette, Kaggle lingo, and how to enter a competition using Kaggle Notebooks. You can also publish and share your work on Kaggle Models!

Looking for a team? Use our Team Up feature to find teammates or express interest in joining an existing team.

Remember: Kaggle is for everyone. Whether you’re teaming up or sharing tips in the competition forum, please follow our Kaggle community guidelines.

Full details on evaluation criteria, submission requirements, and resources are provided here.

Competition’s Official Discord
Continue discussions in our official Kaggle Discord Server, on the 5 Day AI Intensive Course chat space

Discord is perfect for asking questions, connecting with potential teammates, and discussing ideas. Keep in mind:

1. Discord Channels are Public: Do not share private information. Code sharing should always be done publicly on Kaggle.
2. Discord is Unmonitored by Staff: Keep critical questions, insights, and writeups on Kaggle forums for official guidance.
...
12 swag items, awarded to the top 3 projects in each category
...
Open Source: You hereby license and will license your winning Submission and the source code used to generate the Submission under an CC-BY-SA 4.0 Open Source Initiative-approved license that in no event limits commercial use of such code or model containing or depending on such code.
...
Are Participants being excluded from a competition because of the "excessive" costs for access to certain LLMs, external data, or tools that might be used by other Participants. The Host will assess the excessive cost concern by applying a “Reasonableness” standard. The Reasonableness Standard will be determined and applied by the Host in light of things like cost thresholds and accessibility.
