...
2. Search for and enable each API by clicking "Enable":
   ...
   - **Drive API** - For file storage and drive access
...
3. **Bucket Configuration:**
   ...
   - **Location**: Choose same region as your `GOOGLE_CLOUD_LOCATION` (e.g., `us-east1`)
...
- C:\Users\Honri\AppData\Local\Google\Cloud SDK\google-cloud-sdk\platform\bundledpython\python.exe
